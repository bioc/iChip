...
enrichreg(pos=oct4[,1:2],pp=oct4res$pp,ppcut=0.9,isppcut=TRUE,maxgap=500)
enrichreg(pos=oct4[,1:2],pp=oct4res$pp,fdrcut=0.01,isppcut=FALSE,maxgap=500)
...
enrichreg(pos=p53[,1:2],pp=p53res$pp,ppcut=0.9,isppcut=TRUE,maxgap=500)
enrichreg(pos=p53[,1:2],pp=p53res$pp,fdrcut=0.01,isppcut=FALSE,maxgap=500)
